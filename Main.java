...
public class Main {
    public static void main(String[] args){
        ...
        for (CityComponent component : components) {
            component.addSensor(factory.createSensor("temperature", "location1"));
            component.addSensor(factory.createSensor("noise", "location2"));
            component.addSensor(factory.createSensor("pollution", "location3"));
            component.addSensor(factory.createSensor("speed", "location4"));
        }
